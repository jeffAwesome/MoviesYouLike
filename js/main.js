...
/* I try to follow the Tell not ask approach but not sure where I would go for the following functions
** Init Movie Data = I get the movie data but I need to know whether or not any results came back from it
** 
